                              ...
                              <tr class="datarow">
                                 ...
                                 <td>
                                    <div class="function_style">
                                       <a class="btn btn-sm btn-primary" href="{{route('post.restore')}}"><i class="fas fa-trash-restore"></i> Khôi phục</a>
                                       <form action="{{route('post.destroy',['post'=>$item->id])}}" method="post" class="d-inline">
                                        @csrf
                                        @method('DELETE')
